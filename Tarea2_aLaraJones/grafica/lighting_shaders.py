...
class SpotlightTextureGouraudShaderProgram():
    ...
    def __init__(self):
        ...
        vertex_shader = """
            ...
            void main()
            {
                ...
                //spotlight
                vec3 pointToLight = toLight/normalize(toLight);                
                float spotlight = pow(max(dot(-direction,pointToLight),0.0),focused);
                ...
                vertexLightColor = ambient + ((diffuse + specular)*spotlight / attenuation);
            }
            """
...
class SpotlightTexturePhongShaderProgram:
    ...
    def __init__(self):
        ...
        fragment_shader = """
            ...
            void main()
            {
                ...
                float diff = pow(max(dot(norm, -lightDir), 0.0),focused);
                vec3 diffuse = Kd * Ld * diff;
